    ...
    return(
        <div className="mt-12 flex gap-x-8 gap-y-16 justify-between flex-wrap">
            {res.items.map((product:products.Product) => (
                ...
                <Link href="/test" key={product._id} className="w-full flex flex-col gap-4 sm:w-[45%] lg:w-[22%]">
            <div className="relative w-full h-80">
                ...
                {/* To use dangerouslySetInnerHTM we will need to install<isomorphic-dompurify> in oder for prevent someone to input something dangerously. It only allow us to save items like HTML tags */}
